...
for amount in range(1, process_amount + 1):
    ...
    while True:
        try:
            ...
            processes.append(Process(amount, arrival_time, burst_time, priority, finished_state))
            break
        except ValueError:
...
while True:
    ...
    if process_queue[0].remaining_burst_time == 0:
        process_queue[0].completion_time = current_time
        sequence_of_process.append(process_queue.pop(0))
